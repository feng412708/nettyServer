...
public final class WebSocketServerIndexPage {
    ...
    public static ByteBuf getContent(String webSocketLocation) {
        ...
        int receiversCount = WebSocketServerHandler.channels.size();
        for (Channel channel : WebSocketServerHandler.channels) {
            InetSocketAddress insocketInner = (InetSocketAddress) channel.remoteAddress();
            String clientIP = insocketInner.getAddress().getHostAddress();
        ...
        return Unpooled.copiedBuffer(
                "<html><head><meta http-equiv=\"refresh\" content=\"5\">"
                        ...
                        "receiversCount:" + receiversCount + NEWLINE + ipStr +
                        "</form>" + NEWLINE +
                        "</body>" + NEWLINE +
